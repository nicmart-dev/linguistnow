            ...
            try {
                ...
                if (isAxiosError(error)) {
                    ...
                    if (
                        ...
                        toast.error(t('dashboard.errors.serverError'), {
                            description: t(
                                'dashboard.errors.serverErrorDescription'
                            ),
                            duration: 8000,
                        })
                    } else if (
                        ...
                        toast.error(t('dashboard.errors.networkError'), {
                            description: t(
                                'dashboard.errors.networkErrorDescription'
                            ),
                            duration: 8000,
                        })
                    } else {
                        toast.error(t('dashboard.errors.searchError'), {
                            description: errorMessage,
                            duration: 8000,
                        })
                    }
