...
| ------------------- | ------------------------------ | ------------------------------------------------------------------------ |
| **HashiCorp Vault** | Secure OAuth token storage     | [Vault Integration Guide](./n8n-vault-integration-guide.md#deploy-vault) |
...
1. **Ensure shared infrastructure is running:**
   - Vault: See [Vault Integration Guide](./n8n-vault-integration-guide.md#deploy-vault)
