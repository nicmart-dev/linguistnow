...
const options = {
    definition: {
        ...
        info: {
            ...
            version: '1.0.0',
            description: 'API for LinguistNow - A platform connecting linguists with clients through Google Calendar integration',
            contact: {
            ...
            schemas: {
                User: {
                    ...
                    properties: {
                        ...
                        Picture: { type: 'string', format: 'uri', example: 'https://lh3.googleusercontent.com/a/...' },
                        Role: { type: 'string', example: 'Linguist' },
                        'Calendar IDs': { type: 'string', example: 'calendar1@group.calendar.google.com,calendar2@group.calendar.google.com' },
                ...
                HealthCheck: {
                    ...
                    properties: {
                        ...
                        timestamp: { type: 'string', format: 'date-time', example: '2025-12-25T12:00:00.000Z' },
        ...
        tags: [
            ...
            { name: 'Calendars', description: 'Google Calendar availability endpoints' }
        ]
    },
